    ...
    >
      ...
      <div className="mt-10 flex flex-col justify-center items-center gap-5">
        <div className="flex items-center lg:flex-row flex-col justify-center gap-5">
          <p className="flex items-center gap-2 text-xl bg-black w-[320px] px-4 py-2 rounded-md">
        ...
        <p className="flex items-center gap-2 text-xl bg-black w-[320px] py-2 px-4 rounded-md">
